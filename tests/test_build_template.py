...
def test_build_template(dwi1: Dwi, dwi2: Dwi, tmp_path: Path, mocker):
    ...
    n_iter = 2
    template = build_template(volume_list=volume_list, iterations=n_iter)
...
def test_build_multi_metric_template(dwi1: Dwi, dwi2: Dwi, tmp_path: Path, mocker):
